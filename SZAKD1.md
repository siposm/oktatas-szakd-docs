...
Elvileg a 7. vagy 9. hétig le kell majd adni ezt. Ennek megírását én fogom majd intézni, amihez a következőt szeretném kérni mindenkitől. Az oldalamon a /szakd alatt található „feladatkiírási lap” (oldal alja) egy Google Form-hoz vezet, azt kellene alapos átgondolás után kitölteni. Az ott megadott kérdésekre jól definiált válaszokat várnék, ezek alapján pedig elő fogom állítani a hivatalos feladatkiírási lapot.
